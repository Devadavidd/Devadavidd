<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:1a1b27,100:24283b&height=220&section=header&text=Nguyen%20Tuong%20Khang&fontSize=42&fontColor=70a5fd&fontAlignY=35&desc=Full-Stack%20Developer%20%7C%20IoT%20%C2%B7%20AI%20%C2%B7%20Microservices&descSize=18&descColor=a9fef7&descAlignY=55&animation=fadeIn" />

<p align="center">
  <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=70A5FD&center=true&vCenter=true&random=false&width=600&lines=Building+IoT+%26+AI+Products;Microservices+%7C+Full-Stack+%7C+Mobile;RMIT+Vietnam+%F0%9F%87%BB%F0%9F%87%B3;75%2B+Repos+%C2%B7+10+Organizations" alt="Typing SVG" /></a>
</p>

## 👋 About Me

Full-Stack Developer from Vietnam, studying at **RMIT Vietnam**. I build production systems spanning **IoT**, **AI**, and **enterprise platforms** across **10+ organizations** and **75+ repositories**.
...
| Domain | Description | Technologies |
|--------|-------------|-------------|
| 🏭 **IoT & Industrial Monitoring** | Real-time monitoring systems with industrial protocols. Fire alarm control panel integration and sensor data pipelines. | MQTT, OPC UA, BACnet, TypeScript, Node.js |
| 🤖 **AI-Powered Products** | RAG-based AI assistants, AI food tech platforms, enterprise chatbots, and multi-agent development tools. | Python, TypeScript, Claude API, RAG |
| 🔧 **Microservices Architecture** | 15+ service job platform with service discovery, event streaming, API gateway, and distributed transactions. | Java, Spring Boot, Kafka, Eureka |
| 🛒 **Full-Stack Platforms** | E-commerce, racing, and swap platforms with admin dashboards, CMS, and mobile apps. | TypeScript, React, Next.js, Node.js |
| 📱 **Mobile Development** | iOS applications with SwiftUI. Cross-platform mobile apps with React Native. | Swift, TypeScript, React Native |
| ⚡ **Embedded Systems** | Bare-metal OS and hardware interfacing for embedded computing. | C |
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=Devadavidd&color=70a5fd&style=flat-square&label=Profile+Views" />
</p>
